...
## DDS-PNG-CONVERTER-Loc

* RU:
Программа для преобразования всех изображений \[.dds\] в каталоге в формат \[.png\] без потери качества. После конвертации все новые файлы будут помещены в папку «PNG». Подойдёт для небольших объёмов файлов и быстрого преобразования.

* EN:
A program for converting all \[.dds\] images in a catalog to \[.png\] format without loss of quality. After the conversion, all new files will be placed in the PNG folder. It is suitable for small amounts of files and fast conversion.
